...
export function ScrollBanner_1(){
    return(
        <div className="scroll_banner_1">
                    <div className="scroll_banner_1_frame">
                        <div className="scroll_banner_1_title_and_text">
                            <div className="scroll_banner_1_title">
                            Подписка на статус контейнеров через Telegram-бот
                            </div>
                            <div className="scroll_banner_1_text">
                        ...
                        <div className="scroll_banner_1_quote">
                    ...
                    <img className="scroll_banner_1_img" src={require("../templates/mobile_3.png")}></img>
                </div>
    )
}