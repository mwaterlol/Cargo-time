...
import './mystyle.CompanyList.css'

 export function CompanyList(props:any){
    return(
        <div>
            <div className="list_full">
                        <div className="list_full_body">
                            <div className="list_full_title_and_icon">
                                <div className="list_full_title">
                                ...
                                <button  onClick={() => props.changeSnowInfo(false)}>
                                    <img className="list_full_icon_close" src={require("../templates/icon_close.png")}></img></button>
                            </div>
                            <div className="list_full_list">
                                <div className="list_full_column_1">
                                ...
                                <div className="list_full_column_2">
                                    <ul style={{listStyle: "none"}}>
                                ...
                                <div className="list_full_column_3">
                                    <ul style={{listStyle: "none"}}>
                                    <li>Dongjin Shipping</li>
                                        <li>Deutsche Afrika-Linien, Dong Young Shipping</li>
                                        <li>Econship</li>
